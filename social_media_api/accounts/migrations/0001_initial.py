# Generated by Django 6.0 on 2025-12-14 13:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True, help_text='Designates whether this user should be treated as active. Unselect this instead of deleting accounts.', verbose_name='active')),
                ('date_joined', models.DateTimeField(default=django.utils.timezone.now, verbose_name='date joined')),
                ('bio', models.TextField(blank=True, help_text='A short biography about the user.', max_length=500)),
                ('profile_picture', models.ImageField(blank=True, help_text="Path to the user's profile image.", null=True, upload_to='profile_pics/')),
                ('followers', models.ManyToManyField(blank=True, help_text='Users who follow this user.', related_name='following', to='accounts.user')),
